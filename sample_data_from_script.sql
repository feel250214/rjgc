...
-- 4. 插入员工数据
INSERT INTO employee (username, password, name, email, phone, department, position, department_id, position_id,
                      create_time)
VALUES ('admin', '123456', '管理员', 'admin@example.com', '13800138000', '人力资源部', '人力资源经理',
       ...
       ('zhangsan', '123456', '张三', 'zhangsan@example.com', '13800138001', '技术部', '技术总监',
       ...
       ('lisi', '123456', '李四', 'lisi@example.com', '13800138002', '前端组', '前端开发工程师',
       ...
       ('wangwu', '123456', '王五', 'wangwu@example.com', '13800138003', '后端组', '后端开发工程师',
       ...
       ('zhaoliu', '123456', '赵六', 'zhaoliu@example.com', '13800138004', '财务部', '财务经理',
       ...
       ('qianqi', '123456', '钱七', 'qianqi@example.com', '13800138005', '财务部', '会计',
        (SELECT id FROM (SELECT id FROM department WHERE code = 'DEPT003') AS t),
        (SELECT id FROM (SELECT id FROM position WHERE name = '会计') AS t), NOW()),
       ('sunba', '123456', '孙八', 'sunba@example.com', '13800138006', '市场部', '市场经理',
       ...
       ('zhoujiu', '123456', '周九', 'zhoujiu@example.com', '13800138007', '销售部', '销售经理',
       ...
       ('wushi', '123456', '吴十', 'wushi@example.com', '13800138008', '销售部', '销售人员',
        (SELECT id FROM (SELECT id FROM department WHERE code = 'DEPT005') AS t),
